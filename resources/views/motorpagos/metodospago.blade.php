...
@section('content')
<h3 class="page-title">Motor de pagos <small>Métodos de Pago</small></h3>
<div class="page-bar">
...
<div class="row">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bank"></i>Agregar Método de Pago
            </div>
        ...
        <div class="portlet-body">
            <form class="form-inline" role="form">
                ...
                <div class="form-group">
                    <label class="sr-only" for="exampleInputEmail2">Nuevo Método de Pago</label>
                    <input type="email" class="form-control" id="exampleInputEmail2" placeholder="Nuevo Método de Pago">
                </div>
