...
<script type="text/javascript">
    ...
    function eliminaPartida()
    {
        ...
        $.ajax({
        method: "post",            
        url: "{{ url()->route('partidas-deleted') }}",
    ...
    function partidasUpdate(id_)
    {
        ...
        $.ajax({
        method: "post",            
        url: "{{ url()->route('partidas-find-where') }}",
    ...
    function partidasFindAll()
    {
        $.ajax({
           method: "get",           
           url: "{{ url()->route('partidas-find-all') }}",
