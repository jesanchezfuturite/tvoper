...
<script type="text/javascript">
    ...
    function clasificadorInsert()
    {
        ...
        $.ajax({
        method: "post",            
        url: "{{ url()->route('clasificador-insert') }}",
    ...
    function eliminaclasificador()
    {
        ...
        $.ajax({
        method: "post",            
        url: "{{ url()->route('clasificador-deleted') }}",
    ...
    function clasificadorUpdate(id_)
    {
        ...
        $.ajax({
        method: "post",            
        url: "{{ url()->route('clasificador-find-where') }}",
    ...
    function clasificadorActualiza()
    {
        ...
        $.ajax({
        method: "post",            
        url: "{{ url()->route('clasificador-update') }}",
    ...
    function clasificadorFindAll()
    {
        $.ajax({
           method: "get",           
           url: "{{ url()->route('clasificador-find-all') }}",
