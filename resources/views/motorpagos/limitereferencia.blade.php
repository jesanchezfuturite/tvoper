...
$.ajax({
           method: "POST",
           url: "{{ url()->route('limite-referencia-insert') }}",
...
$.ajax({
           method: "POST",
           url: "{{ url()->route('limite-referencia-update') }}",
...
function update(id_)
{
	$.ajax({
           method: "POST",
           url: "{{ url()->route('limite-referencia-find') }}",
...
function eliminar()
{
  ...
  $.ajax({
           method: "POST",
           url: "{{ url()->route('limite-referencia-deleted') }}",
           data: { id: id_, _token: '{{ csrf_token() }}' }
       })
        .done(function (response) { 
