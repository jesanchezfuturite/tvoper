...
<script type="text/javascript">
    ...
    */ 
    $("#addSecond").click( function(){
       ...
       // console.log(JSON.stringify(newsaved));
        ...
        $.ajax({
            method: "POST",
            url: "{{ url()->route('asignaherramientas/saveuserprofile') }}",
    ...
    */
    ...
    $("#users_select").change(function (){
        ...
        $.ajax({
            method: "POST",
            url: "{{ url()->route('asignaherramientas/loaduserprofile') }}",
    ...
    */
    ...
    $("#deleteSecond").click( function (){
        ...
        $.ajax({
            method: "POST",
            url: "{{ url()->route('asignaherramientas/deleteelementuserprofile') }}",
