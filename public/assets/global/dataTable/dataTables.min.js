...
(function(f) {
    ...
    function ub(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            h = a.aanFeatures,
            g = '<input type="search"  class="' + b.sFilterInput + ' form-control input-small input-inline" style="border-width:1px !important;"/>',
            k = d.sSearch;
    ...
    f.extend(q.ext.classes, {
        ...
        sPageButtonActive: "current btn green border-bottom border-top",
    ...
    f.extend(!0, q.ext.renderer, {
        header: {
            ...
            jqueryui: function(a, b, c, d) {
                f("<div/>").addClass(d.sSortJUIWrapper).append(b.contents()).append(f("<span class='badge'/>").addClass(d.sSortIcon + " " + c.sSortingClassJUI)).appendTo(b);
                f(a.nTable).on("order.dt.DT", function(e, f, g, k) {
