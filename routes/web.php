...
Route::group(["prefix" => getenv("APP_PREFIX") ?? "/"], function(){
    ...
    Route::get('/limite-referencia-fin-all', 'MotorpagosController@limitereferenciaFindAll')->name('limite-referencia-fin-all');
    /******************** Banco ******************/
    ...
    /******************  Tipo Servicio  ***************/
    Route::get('/tiposervicio-find-all-where', 'MotorpagosController@findTipoServicioAllWhere')->name('tiposervicio-find-all-where');
    ...
    //Route::get('/envia-correo', 'ConciliacionController@enviacorreo')->name('envia-correo');
    ...
    Route::group(['middleware' => ['verifyassignment']],function(){
    	Route::get('/cfdi-correccion', 'CorreccioncfdiController@index')->name('cfdi-correccion');
    	Route::get('/cfdi-manual', 'ManualcfdiController@index')->name('cfdi-manual');
    ...
    Route::post('/update-status-atencion', 'PortalSolicitudesTicketController@updatestatusAtencion')->name("update-status-atencion");
    Route::post('/aceptar-rechazar-tramite', 'PortalSolicitudesController@aceptarRechazarTramite')->name("aceptar-rechazar-tramite");
