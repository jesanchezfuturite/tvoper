...
class TransaccionesRepositoryEloquent extends BaseRepository implements TransaccionesRepository
{
    ...
    public function consultaTransacciones($fechaIn,$fechaF)
    {
        ...
        ->select($this->db . '.status.Descripcion as status','oper_transacciones.id_transaccion as idTrans',
            'oper_entidad.nombre as entidad',$this->db . '.tipo_servicios.Tipo_Descripcion as tiposervicio',
            'oper_tramites.nombre','oper_tramites.apellido_paterno','oper_tramites.apellido_materno',
            'oper_transacciones.fecha_transaccion',
            'oper_transacciones.banco as BancoSeleccion',$this->db . '.tipopago.Descripcion as tipopago',
            'oper_transacciones.importe_transaccion as TotalTramite',$this->db . '.tipo_servicios.Tipo_Code as tiposervicio_id',
            'oper_transacciones.estatus as estatus_id','oper_tramites.rfc as rfc','oper_familia.nombre as familia',
            'oper_transacciones.referencia','oper_transacciones.id_transaccion_motor','oper_processedregisters.id')
    ...
    public function findTransaccionesEntidad($user,$variable1,$variable2)
    {
